    ...
    sidebarLayout(
        sidebarPanel(
            ...
            numericInput("contrib",
                         ...
                         max = 25,
                         value = 17),
            numericInput("defer_years",
                         "Time spent defering in Years",
                         min = 0,
                         max = 50,
                         value = 0),
            numericInput("salary_increments",
                         "Average Annual salary increments (Percent)",
                         min = 0,
                         max = 20,
                         value = 3.5),
            numericInput("CPI",
                         "Average Consumer price index (approx. inflation)",
                         min = 0,
                         max = 20,
                         value = 3.5),
